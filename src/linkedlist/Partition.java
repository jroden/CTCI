...
public class Partition {
    ...
    // than or equal to x
    // solution: we can do this in O(n) time by looping through once, if any nodes with data less than x are encountered,
    // we can insert those at the front of the linkedList
